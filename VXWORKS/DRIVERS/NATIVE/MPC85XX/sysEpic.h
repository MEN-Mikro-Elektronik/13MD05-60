...
--------------------
01f,06may04,mil  Fixed macro INCLUDE_EPIC_CRT_INTR.
...
#if 0
#define EPIC_DUART1_INT_VEC_REG EPIC_IN_INT26_VEC_REG
#define EPIC_DUART1_INT_DES_REG EPIC_IN_INT26_DES_REG
#define EPIC_DUART2_INT_VEC_REG EPIC_IN_INT27_VEC_REG
#define EPIC_DUART2_INT_DES_REG EPIC_IN_INT27_DES_REG
#endif							/* 0 */

#if FALSE
#define EPIC_PROC_CTASK_PRI_REG (EPIC_CCSROFF + 0x00080)	/* Proc. current task */
#define EPIC_PROC_INT_ACK_REG	(EPIC_CCSROFF + 0x000a0)	/* Int. acknowledge */
#define EPIC_PROC_EOI_REG	(EPIC_CCSROFF + 0x000b0)	/* End of interrupt */
#endif							/* FALSE */
...
#define EPIC_GCR_RESET		BIT_EPIC(31)
#define EPIC_GCR_MODE_MIXED	BIT_EPIC(29)

/* IPI Vector/Priority registers */

#define EPIC_IPIVPR_INTR_MSK        BIT_EPIC(31)
#define EPIC_IPIVPR_INTR_ACTIVE     BIT_EPIC(30)
#define EPIC_IPIVPR_PRIORITY_MSK    (BIT_EPIC(19) | BIT_EPIC(18) | BIT_EPIC(17) | BIT_EPIC(16))
...
#define EPIC_GTVPR_INTR_MSK        BIT_EPIC(31)
#define EPIC_GTVPR_INTR_ACTIVE     BIT_EPIC(30)
#define EPIC_GTVPR_PRIORITY_MSK    (BIT_EPIC(19) | BIT_EPIC(18) | BIT_EPIC(17) | BIT_EPIC(16))
...
#define EPIC_IRQSR0_MSG_INT(n)  (BIT_EPIC(15-(n)) & EPIC_IRQSR0_MSG_INT_MSK)
#define EPIC_IRQSR0_EX_INT_MSK  0xfff
#define EPIC_IRQSR0_EX_INT(n)   (BIT_EPIC(11-(n)) & EPIC_IRQSR0_EX_INT_MSK)
#define EPIC_IRQSR1_IN_INT(n)   BIT_EPIC(31-(n))
#define EPIC_CISR0_MSG_INT_MSK  0xf000
#define EPIC_CISR0_MSG_INT(n)   (BIT_EPIC(15-(n)) & EPIC_CISR0_MSG_INT_MSK)
#define EPIC_CISR0_EX_INT_MSK   0xfff
#define EPIC_CISR0_EX_INT(n)    (BIT_EPIC(11-(n)) & EPIC_CISR0_EX_INT_MSK)
#define EPIC_CISR1_IN_INT(n)    BIT_EPIC(31-(n))

/* Message registers */

#define EPIC_MER_EN_MSK         0xf
#define EPIC_MER_EN(n)          (BIT_EPIC(n) & EPIC_MER_EN_MSK)
#define EPIC_MSR_ST_MSK         0xf
#define EPIC_MSR_ST(n)          (BIT_EPIC(n) & EPIC_MER_ST_MSK)

/* EIVPR registers */

#define EPIC_EIVPR_INTR_MSK         BIT_EPIC(31)
#define EPIC_EIVPR_INTR_ACTIVE      BIT_EPIC(30)
#define EPIC_EIVPR_INTR_POLARITY    BIT_EPIC(23)
#define EPIC_EIVPR_INTR_SENSE       BIT_EPIC(22)
#define EPIC_EIVPR_POLARITY(p)      ((p) << 23)
#define EPIC_EIVPR_SENS(s)          ((s) << 22)
#define EPIC_EIVPR_PRIORITY_MSK	    (BIT_EPIC(19) | BIT_EPIC(18) | BIT_EPIC(17) | BIT_EPIC(16))
...
#define EPIC_EIDR_EX_PIN        BIT_EPIC(31)
#define EPIC_EIDR_CRIT_INT      BIT_EPIC(30)
...
#define EPIC_IIVPR_INTR_MSK         BIT_EPIC(31)
#define EPIC_IIVPR_INTR_ACTIVE      BIT_EPIC(30)
#define EPIC_IIVPR_INTR_POLARITY    BIT_EPIC(23)
#define EPIC_IIVPR_POLARITY(p)      ((p) << 23)
#define EPIC_IIVPR_PRIORITY_MSK     (BIT_EPIC(19) | BIT_EPIC(18) | BIT_EPIC(17) | BIT_EPIC(16))
...
#define EPIC_IIDR_EX_PIN        BIT_EPIC(31)
#define EPIC_IIDR_CRIT_INT      BIT_EPIC(30)

/* MIVPR registers */

#define EPIC_MIVPR_INTR_MSK         BIT_EPIC(31)
#define EPIC_MIVPR_INTR_ACTIVE      BIT_EPIC(30)
#define EPIC_MIVPR_PRIORITY_MSK     (BIT_EPIC(19) | BIT_EPIC(18) | BIT_EPIC(17) | BIT_EPIC(16))
...
#define EPIC_MIDR_EX_PIN        BIT_EPIC(31)
#define EPIC_MIDR_CRIT_INT      BIT_EPIC(30)

/* IPIDR registers */

#define EPIC_IPIDR_P0           BIT_EPIC(0)

/* CTPR register */

#define EPIC_CTPR_TASKPRI_MSK   (BIT_EPIC(3) | BIT_EPIC(2) | BIT_EPIC(1) | BIT_EPIC(0))
#define EPIC_CTPR_TASKPRI(p)    ((p) & EPIC_CTPR_TASKPRI_MSK)

/* WHOAMI register */

#define EPIC_WHOAMI_ID_MSK      (BIT_EPIC(4) | BIT_EPIC(3) | BIT_EPIC(2) | BIT_EPIC(1) | BIT_EPIC(0))
...
#define EPIC_PCI_INT_NUM            8
#define EPIC_PCI_INT_VEC            (EPIC_PCI_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RIOWRERR_INT_NUM       9
#define EPIC_RIOWRERR_INT_VEC       (EPIC_RIOWRERR_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RIODBELL_INT_NUM       10
#define EPIC_RIODBELL_INT_VEC       (EPIC_RIODBELL_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RIOMSGOUT_INT_NUM      11
#define EPIC_RIOMSGOUT_INT_VEC      (EPIC_RIOMSGOUT_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RIOMSGIN_INT_NUM       12
#define EPIC_RIOMSGIN_INT_VEC       (EPIC_RIOMSGIN_INT_NUM + EPIC_VEC_IN_IRQ0)
...
#define EPIC_FEC_INT_NUM            25
#define EPIC_FEC_INT_VEC            (EPIC_FEC_INT_NUM + EPIC_VEC_IN_IRQ0)
...
#define EPIC_IIN29_INT_NUM          29
#define EPIC_IIN29_INT_VEC          (EPIC_IIN29_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_CPM_INT_NUM            30
#define EPIC_CPM_INT_VEC            (EPIC_CPM_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_IIN31_INT_NUM          31
#define EPIC_IIN31_INT_VEC          (EPIC_IIN31_INT_NUM + EPIC_VEC_IN_IRQ0)


	IMPORT STATUS sysEpicIntConnect(
	VOIDFUNCPTR * vector,
	VOIDFUNCPTR routine,
	int parameter
	);
	IMPORT STATUS sysEpicIntDisconnect (
	VOIDFUNCPTR * vector,
	VOIDFUNCPTR routine,
	int parameter
	);
	IMPORT int sysEpicIntEnable(
	int vector
	);
	IMPORT int sysEpicIntDisable(
	int vector
	);
	IMPORT void sysEpicInit(
	void
	);
	IMPORT STATUS sysEpicIntrInit(
	void
	);
	IMPORT int sysEpicVecOptionsSet(
	int vector,
	UINT32 mask,
	UINT32 options
	);
	IMPORT UINT32 sysEpicVecOptionsGet(
	int vector
	);
#ifdef INCLUDE_EPIC_CRT_INTR
	IMPORT UINT32 epicCisr0Get(
	void
	);
	IMPORT UINT32 epicCisr1Get(
	void
	);
	IMPORT int sysEpicCrtIntSet(
	int vector
	);
	IMPORT int sysEpicCrtIntUnset(
	int vector
	);
	IMPORT int sysEpicCrtIntGet(
	int vector
	);
#endif							/* INCLUDE_EPIC_CRT_INTR */
	IMPORT int epicCurTaskPrioSet(
	int prioNum
	);
	IMPORT int epicIntAck(
	void
	);
	IMPORT void epicEOI(
	void
	);
	IMPORT ULONG epicGetVecRegAdrs(
	int vector
	);
	IMPORT ULONG epicGetDestRegAdrs(
	int vector
	);
	IMPORT STATUS epicIntSourceSet(
	ULONG srcAddr,
	int polarity,
	int sense,
	int priority,
	...
	IMPORT STATUS epicIntSourceGet(
	ULONG srcAddr,
	int *pEnableMask,
	int *pPolarity,
	int *pSense,
	...
	IMPORT UINT32 sysEpicRegRead(
	ULONG regNum
	);
	IMPORT void sysEpicRegWrite(
	ULONG regNum,
	UINT32 regVal
	);
