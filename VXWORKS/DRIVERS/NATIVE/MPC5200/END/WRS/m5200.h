/* m5200.h - Motorola MPC5200 CPU control registers */
...
#define MPC5200_PCI_DEVICE_ID	0x5803
...
#define MFSPR(rn)	({unsigned int rval; \
			__asm__("mfspr %0," stringify(rn) : "=r" (rval));\
			rval;})

#define MTSPR(rn, v) __asm__("mtspr " stringify(rn) ",%0" : : "r" (v))

#define SPRN_SVRG2	0x11E	/* G2_LE core: system version register */
