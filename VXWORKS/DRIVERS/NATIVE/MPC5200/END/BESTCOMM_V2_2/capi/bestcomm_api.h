...
*
* Filename:     $Source: /Customizations/VxWorks-6.0/mpc5200/target/config/lite5200.pkr/bestComm/capi/bestcomm_api.h,v $
 ...
 *          or invalid taskId.
 */
static __inline__ int TaskStatus(TaskId taskId)
{
 ...
 */
static __inline__ TaskBD_t *TaskGetBD(TaskId taskId, BDIdx bd)
{
    TaskBD_t *bdTab;
 ...
 */
static __inline__ TaskBD_t *TaskGetBDRing(TaskId taskId)
{
 ...
 */
static __inline__ int TaskIntClear(TaskId taskId)
{
 ...
 */
static __inline__ TaskId TaskIntStatus(TaskId taskId)
{
    uint32 pending;
 ...
 */
static __inline__ int TaskIntPending(TaskId taskId)
{
    uint32 pending;
 ...
 */
static __inline__ TaskId TaskIntSource(void)
{
    uint32 pending;
 ...
 */
static __inline__ uint16 TaskBDInUse(TaskId taskId)
{
