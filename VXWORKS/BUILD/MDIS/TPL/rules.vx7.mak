...
# Fix for VxWorks >= 6.3:
# With inlining of static functions and reordering of instructions lots of code doesn't work!!!
ifneq (,$(findstring gnu,$(TOOL)))
	ifeq ($(MEN_VXWORKS_ENV_VER),VXWORKS_6_0)
...
ifeq ($(MEN_VXWORKS_ENV_VER),VXWORKS_6_0)
custom.mak:
	@$(ECHO) "==> custom.mak for vxWorks 6.x doesnt exist, creating template custom.mak"
...
custom.mak:
	@$(ECHO) "==> custom.mak for vxWorks 7 doesnt exist, creating template custom.mak"
	@$(ECHO) "# custom.mak:"													        		  > custom.mak
	@$(ECHO) "CUSTOM_MAK_MSG = custom.mak has been read successfully"                             >> custom.mak
	@$(ECHO) "#  - please edit this files to add something not covered but removed by mdiswizvx"  >> custom.mak
	@$(ECHO) "#"  																			  	  >> custom.mak
