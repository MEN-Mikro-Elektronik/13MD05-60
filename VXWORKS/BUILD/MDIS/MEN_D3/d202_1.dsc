...
#
#        Author: ds
#         $Date: 2001/09/03 09:26:34 $
#     $Revision: 1.1 $
#
#   Description: Metadescriptor for D202 PC*MIP carrier board
#                in a MEN standard D3 system with CPCI slots.
#
#****************************************************************************
...
D202_1 {
	...
	#       connects the backplane (bus 2) of the D2 system with PCI bus 0. 

	#PCI_BUS_PATH		= BINARY   0x1e,0x0c	# for slot 5
	#PCI_BUS_PATH		= BINARY   0x1e,0x0d	# for slot 4
	PCI_BUS_PATH		= BINARY   0x1e,0x0e	# for slot 3
	#PCI_BUS_PATH		= BINARY   0x1e,0x0f	# for slot 2
