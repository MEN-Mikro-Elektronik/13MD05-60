 ...
 **************************************************************************
 */
static const char RCSid[]="$Id: whets.c,v 1.2 2010/11/11 11:11:11 UFranke Exp $";

/*
 *      $Log: whets.c,v $
 *      Revision 1.2  2010/11/11 11:11:11  UFranke
 *      R: exception calling time()
 *      M: fixed missing pointer 
 *
 * 
 */
...
/*  #define DP /\* comment for Single Precision *\/ */
