...
static int SYSP_FromRawVme( char *dest, int destLen, void *src, int adrSpace )
{
	...
	{
		case 24:
			s += SYSP_SNPRINTF( s, sizeof(buf), "%02X0000,%04X0000,%02X0000",
							   p8[0], SYSP_FROMBE16(*((u_int16*)&p8[1])), p8[3] );
			break;

		case 32:
			s += SYSP_SNPRINTF( s, sizeof(buf), "%04X0000,%04X0000,%04X0000",
							   SYSP_FROMBE16(p16[0]), SYSP_FROMBE16(p16[1]),
							   SYSP_FROMBE16(p16[2]) );
			break;

		case 64:
			s += SYSP_SNPRINTF( s, sizeof(buf), "%08X%02X000000,%04X0000,%02X000000",
